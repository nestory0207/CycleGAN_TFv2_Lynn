...
def make_dataset(img_paths, batch_size, load_size, crop_size, training, seed, drop_remainder=True, shuffle=True, repeat=1):
    if training:
        @tf.function
...
def make_zip_dataset(A_img_paths, B_img_paths, batch_size, load_size, crop_size, training, shuffle=True, repeat=False):
    ...
    A_dataset = make_dataset(A_img_paths, batch_size, load_size, crop_size, training, seed=random_seed, drop_remainder=True, shuffle=shuffle, repeat=A_repeat)
    B_dataset = make_dataset(B_img_paths, batch_size, load_size, crop_size, training, seed=random_seed, drop_remainder=True, shuffle=shuffle, repeat=B_repeat)
