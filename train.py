...
py.arg('--crop_size', type=int, default=256*2)  # then crop to this size
...
A_img_paths = sorted(py.glob(py.join(args.datasets_dir, args.dataset, "train", 'NECT'), '*.png'))
B_img_paths = sorted(py.glob(py.join(args.datasets_dir, args.dataset, "train", 'T2'), '*.png'))
...
A_img_paths_test = sorted(py.glob(py.join(args.datasets_dir, args.dataset, "test", 'NECT'), '*.png'))
B_img_paths_test = sorted(py.glob(py.join(args.datasets_dir, args.dataset, "test", 'T2'), '*.png'))
